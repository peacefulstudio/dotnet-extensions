...
// Workaround: `Peaceful.Extensions.Serilog` is a sibling namespace of
// `Peaceful.Extensions.Serilog.Tests`, so C# namespace-member lookup resolves
...
namespace Peaceful.Extensions.Serilog.Tests;
...
public class TraceContextEnricherTests
{
    ...
    private static readonly ActivitySource TestSource = new("Peaceful.Extensions.Serilog.Tests");
    ...
    private sealed class CollectingSink : global::Serilog.Core.ILogEventSink
    {
    ...
    /// <summary>
    /// Minimal sink that runs a Serilog <see cref="global::Serilog.Formatting.ITextFormatter"/>
    ...
    /// </summary>
    private sealed class FormattingSink : global::Serilog.Core.ILogEventSink
    {
        private readonly global::Serilog.Formatting.ITextFormatter _formatter;
        private readonly TextWriter _writer;
        private readonly object _gate = new();

        public FormattingSink(global::Serilog.Formatting.ITextFormatter formatter, TextWriter writer)
        {
